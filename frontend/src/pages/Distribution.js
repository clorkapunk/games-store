...
const Distribution = () => {
    ...
    let questions = [
        {
            id: 0,
            q: 'Why should I distribute my game on the Sus Games Store?',
            a: 'The Sus Games Store has a global audience of over 230M+ users, a 88%/12% revenue split and additional no-cost services to help bring your game to market. For games built on Unreal Engine, engine royalty fees are waived for in-store purchases using Sus\'s payment processor. In-app purchases and products using their own payment processor are not exempt from engine royalties.'
        },
        {
            id: 1,
            q: 'My game is built with Unity or another engine, can I bring it to the Sus Games store?',
            a: 'Yes, the Sus Games store is engine-agnostic. Sus is aiming to bring great games to players, regardless of your engine choice.'
        },
        {
            id: 2,
            q: 'What are the Sus Games Store self-service publishing tools?',
            a: 'They are a suite of tools within the Sus Developer Portal used by developers to set up their game pages, pricing, offers, builds, and updates on the Sus Games Store.'
        },
        {
            id: 3,
            q: 'What is the Sus Developer Portal?',
            a: 'The Developer Portal is the central hub to distribute games on the Sus Games Store and enhance games with Sus Online Services. The Developer Portal is used to update product information, configure back-end services, support players, and view game financial data, usage reports, and other statistical data.'
        },
        {
            id: 4,
            q: 'What other developer tools does Sus offer?',
    ...
    return (
        <Container style={{minHeight: "100vh", padding: 0}} fluid={false}>
            ...
            <div className="distribution-top-image">
                <div
            ...
            <div className="distribution-community-card" style={{display: "flex", justifyContent: "center"}}>
                <Row style={{width: '100%'}}>
                    <Col md={12} className="mt-4" style={{
                        ...
                        <div
                            className="distribution-community-card-img-div"
                            style={{display: 'flex', flexBasis: '50%', justifyContent: "center", alignItems: "center"}}>
                            <img className="distribution-community-card-img" style={{height: "90%"}} src="https://media.tenor.com/xzjlrhYq_lQAAAAj/cat-nyan-cat.gif"/>
                        </div>
                        <div style={{
                            flexBasis: '50%',
                            display: "flex",
            ...
            <Row className='mt-4 mb-5'>
                <div  style={{display: "flex", justifyContent: "center", alignItems: "center", color: "white"}}>
                    <h1 className="distribution-questions-title" style={{margin: 0}}>Frequently Asked Questions</h1>
                </div>
                <Accordion className='mt-3' defaultActiveKey="0" style={{borderRadius: 0}}>
                    {questions.map(item =>
                        <Accordion.Item eventKey={item.id} style={{
