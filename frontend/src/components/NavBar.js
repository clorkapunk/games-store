...
const NavBar = observer(() => {
    ...
    return (
        <>
            ...
            {/*<Navbar collapseOnSelect style={{background: "#18181C"}} variant="dark" expand="lg">*/}
            {/*    <Container className='full-size-navbar'>*/}
            ...
            <Navbar collapseOnSelect style={{background: "#18181C", padding: "5px 40px"}} variant="dark" expand="xxl">
                    <Navbar.Brand style={{
                        color: "white",
                        textDecoration: "none",
                        display: "flex",
